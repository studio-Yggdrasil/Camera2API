...
/**
 * Created by dlrud on 2018-01-29.
 */

public class SeekBar_Vertical extends SeekBar {

    public SeekBar_Vertical(Context c) {
        super(c);
    }



    public SeekBar_Vertical(Context c, AttributeSet attrs)    {
        super(c, attrs);
    ...
    public SeekBar_Vertical(Context c, AttributeSet attrs, int defStyle) {
