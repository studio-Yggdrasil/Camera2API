...
public class SeekBar_Awb extends SeekBar {

    private int mProgress;
    private SeekBar_Awb mAwbSeekBar = this;
    private OnAwbSeekBarChangeListener mOnAwbSeekBarChangeListener;

    public SeekBar_Awb(Context context) {
        super(context);
        init();
    }

    public SeekBar_Awb(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SeekBar_Awb(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public SeekBar_Awb(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
